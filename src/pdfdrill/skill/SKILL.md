...
Attestation token — the LAST line of this SKILL. If you can read this, you read the whole file. Run `pdfdrill preflight --ack DRILL-bde6be44` before any build/extract command.
DRILL-bde6be44
<!-- PREFLIGHT-TOKEN:END -->

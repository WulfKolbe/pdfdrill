...
Attestation token — the LAST line of this SKILL. If you can read this, you read the whole file. Run `pdfdrill preflight --ack DRILL-15ea839b` before any build/extract command.
DRILL-15ea839b
<!-- PREFLIGHT-TOKEN:END -->

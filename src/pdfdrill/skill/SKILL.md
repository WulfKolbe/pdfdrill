...
Attestation token — the LAST line of this SKILL. If you can read this, you read the whole file. Run `pdfdrill preflight --ack DRILL-a0e83ef2` before any build/extract command.
DRILL-a0e83ef2
<!-- PREFLIGHT-TOKEN:END -->

...
Attestation token — the LAST line of this SKILL. If you can read this, you read the whole file. Run `pdfdrill preflight --ack DRILL-b8ebe18a` before any build/extract command.
DRILL-b8ebe18a
<!-- PREFLIGHT-TOKEN:END -->

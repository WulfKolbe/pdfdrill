...
Attestation token — the LAST line of this SKILL. If you can read this, you read the whole file. Run `pdfdrill preflight --ack DRILL-73e4576f` before any build/extract command.
DRILL-73e4576f
<!-- PREFLIGHT-TOKEN:END -->

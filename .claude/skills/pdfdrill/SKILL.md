...
Attestation token — the LAST line of this SKILL. If you can read this, you read the whole file. Run `pdfdrill preflight --ack DRILL-8451428d` before any build/extract command.
DRILL-8451428d
<!-- PREFLIGHT-TOKEN:END -->

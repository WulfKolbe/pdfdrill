...
Attestation token — the LAST line of this SKILL. If you can read this, you read the whole file. Run `pdfdrill preflight --ack DRILL-41307745` before any build/extract command.
DRILL-41307745
<!-- PREFLIGHT-TOKEN:END -->

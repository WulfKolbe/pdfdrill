...
Attestation token — the LAST line of this SKILL. If you can read this, you read the whole file. Run `pdfdrill preflight --ack DRILL-2faa9efe` before any build/extract command.
DRILL-2faa9efe
<!-- PREFLIGHT-TOKEN:END -->

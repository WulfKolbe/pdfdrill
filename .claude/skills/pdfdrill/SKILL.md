...
Attestation token — the LAST line of this SKILL. If you can read this, you read the whole file. Run `pdfdrill preflight --ack DRILL-ba6401ed` before any build/extract command.
DRILL-ba6401ed
<!-- PREFLIGHT-TOKEN:END -->

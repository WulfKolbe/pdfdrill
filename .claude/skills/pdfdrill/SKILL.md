...
Attestation token — the LAST line of this SKILL. If you can read this, you read the whole file. Run `pdfdrill preflight --ack DRILL-a22b6cd1` before any build/extract command.
DRILL-a22b6cd1
<!-- PREFLIGHT-TOKEN:END -->

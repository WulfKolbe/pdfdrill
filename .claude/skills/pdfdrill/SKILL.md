...
Attestation token — the LAST line of this SKILL. If you can read this, you read the whole file. Run `pdfdrill preflight --ack DRILL-e1e117d7` before any build/extract command.
DRILL-e1e117d7
<!-- PREFLIGHT-TOKEN:END -->

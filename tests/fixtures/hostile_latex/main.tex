...
%% (d) an inclusion NO graphic block covers -- an orphan. Before 357 this
%%     produced no object at all: no SVG, no tiddler, no report row.
\includegraphics[width=2cm]{figs/plain}

%% (e) one INSIDE a tikzpicture node: covered by that block, not an orphan
\begin{tikzpicture}\node at (0,0) {\includegraphics{figs/inner}};\end{tikzpicture}
